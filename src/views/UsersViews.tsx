...
const UsersView = () => {
  ...
  const validarUsername = (valor:string) => {
    if (valor.trim() === '') {
    ...
    <View style={styles.modalContent}>
      ...
      <View style={styles.inputContainer}>
        <TextInput
          ...
          onChangeText={(valor) => {
            setUsername(valor);
            validarUsername(valor);
          }}
        />
        {!usernameValido && <Text style={{ color: 'red' }}>El nombre de usuario es requerido</Text>}
        <DropDownPicker
          open={open}
          value={value}
...
const styles = StyleSheet.create({
  ...
  usernameInput: {
    marginBottom: 8, // Ajusta el espacio entre el input y el dropdown
  },
});
