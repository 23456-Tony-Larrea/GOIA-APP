                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card( // Usar un Card en lugar de un ListTile
                      ...
                      onTap: () => _connectToDevice(context, results[index],device.name!)
...
void _connectToDevice(BuildContext context, BluetoothDiscoveryResult device, String deviceName) async {
  BluetoothConnection connection = await _bluetoothController.connectToDevice(context, device) as BluetoothConnection;
